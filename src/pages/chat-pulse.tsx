...
const Chat = () => {
  return (
    <>
      <Seo title="Chat pulse" description="app pour message" />
      <div className="px-2 container   lg:px-24 mx-auto p-5 h-screen 
       rounded-3xl my-auto">
              ...
              <div className="bg-white dark:bg-slate-800  h-full rounded-3xl overflow-hidden pb-10 relative">
                <div className="py-3 h-full  ">
                  ...
                  <div className="mt-10 h-full rounded-sm">
                    <ul
                      role="list"
                      className="divide-y divide-gray-100 dark:divide-gray-700 overflow-auto h-full cursor-wait"
                    >
          ...
          <div className="w-8/12 h-full">
            <div className="flex flex-col h-full gap-2">
              <div className="bg-white dark:bg-slate-800  h-24 rounded-3xl px-4">
                <div className="h-full w-full flex flex-row gap-2 justify-center items-center py-4">
                  <div className=" grow flex gap-2  ">
                    <div className=" grow">
                      <div className="flex min-w-0 gap-x-4 cursor-wait">
                        <div
                          className="h-12 w-12 flex-none rounded-full bg-gray-500 animate-pulse"
                        ...
                        <div className="min-w-0 flex-auto gap-2 ">
                          <div className="w-32 h-5 rounded-sm animate-pulse bg-gray-500">
                          </div>
                          <div className="w-14 mt-2 h-3 rounded-sm animate-pulse bg-gray-500">
              ...
              <div className="bg-white dark:bg-slate-800  h-full rounded-xl py-2 overflow-hidden  relative">
                <div className="h-full px-5 py-2 overflow-auto cursor-wait">
		...
		C911.101,206.3,887.8,171.3,857.7,141.3z"
                    ...
                    <svg
                      className="h-6 w-6 cursor-pointer hover:rotate-180"
                      fill="#000000"
                      width="800px"
                      height="800px"
                      viewBox="0 0 56 56"
