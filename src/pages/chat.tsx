      ...
      <div className=" mx-auto p-5 h-screen">
          ...
          <div className="w-8/12 h-full">
            <div className="flex flex-col h-full gap-2">
              ...
              <div className="flex gap-1 h-20">
                <div className="bg-white dark:bg-slate-800 h-full rounded-xl  w-11/12">
                  <div className="flex gap-1  justify-center items-center h-full py-3 px-6">
                    <svg
                      fill="#000000"
                      version="1.1"
                      id="Capa_1"
		...
		C911.101,206.3,887.8,171.3,857.7,141.3z"
                ...
                <div className="h-full  w-2/12 flex gap-1">
                  <div className="bg-white dark:bg-slate-800 h-full rounded-xl w-6/12">
			...
			c1.5,0,2.721-1.107,2.721-2.47s-1.221-2.47-2.721-2.47h-5.942V42.26C34.111,42.215,40.125,36.73,40.125,29.994z"
                  ...
                  <div className="bg-red-600 h-full rounded-xl w-6/12 p-5">
